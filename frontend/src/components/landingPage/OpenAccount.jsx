...
function OpenAccount() {
  return (
    <div className='bg-linear-to-r from-blue-500 to-red-600 dark:bg-linear-to-r dark:from-gray-900 dark:to-gray-900 p-12 flex flex-col justify-center items-center'>
